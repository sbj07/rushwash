				...
				<div class="container-fluid">
					...
					<main>
								...
								<table border="1">
									...
									<div class="btn-area">
										<button onclick="location.href='/rushwash/admin/board/faq/edit?no=<%= vo.getNo() %>'">수정</button>
										<button onclick="location.href='/rushwash/admin/board/faqDelete?no=<%= vo.getNo() %>'">삭제</button>
									</div>
							</main>
